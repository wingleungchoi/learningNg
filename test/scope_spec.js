...
describe("Scope", function() {
  ...
  describe("digest", function(){
    ...
    it("executes $apply'ed function and startsd the digest", function(){
    ...
    it("executes $evalAsync'ed functions added by watch functions", function() {
      ...
      if (!scope.asyncEvaluated) { scope.$evalAsync(function(scope) {
      scope.asyncEvaluated = true; });
      }
      return scope.aValue; },
      function(newValue, oldValue, scope) { } );
      scope.$digest(); expect(scope.asyncEvaluated).toBe(true);
    });
    ...
    it("catches exceptions in $applyAsync", function(done) {
      scope.$applyAsync(function(scope){
        throw "Error of testing catches exceptions in $applyAsync";
      });
      scope.$applyAsync(function(scope) {
        throw "Error catches exceptions in $applyAsync 2";
      });
      scope.$applyAsync(function(scope){
        scope.applied = true;
      });
    ...
    it("catches exceptions in $$postDigest", function() {
      ...
      scope.$$postDigest(function() {
        throw "Error of testing catches exceptions in $$postDigest";
      });
      scope.$$postDigest(function(){
        didRun = true;
      });
